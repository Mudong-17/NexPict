...
export default () => {
  ...
  const deletePlugin = async (id: string) => {
    await window.electron.invoke('PluginServices:deletePlugin', { pluginId: id });
    fetchPlugins(true);
  };
    ...
    <div className="h-full flex flex-col gap-8">
      <div className="flex items-center gap-2">
        ...
        <Button
          appearance="primary"
          onClick={async () => {
            const result: any = await window.electron.invoke('PluginServices:download', {
              url: downloadUrl,
            });
            if (result.code === 200) {
              fetchPlugins();
                ...
                <CardHeader
                  ...
                  description={
                    <div className="flex flex-col gap-2">
                      ...
                      <Caption1>
                        <span className="line-clamp-2">{item.metadata.description}</span>
                      </Caption1>
                    </div>
                  }
                />
